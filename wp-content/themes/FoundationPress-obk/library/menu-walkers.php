...
if ( ! class_exists( 'foundationpress_left_off_canvas_walker' ) ) :
class foundationpress_left_off_canvas_walker extends Walker_Nav_Menu {

 function start_lvl( &$output, $depth = 0, $args = array() ) {
     $indent = str_repeat("\t", $depth);
     $output .= "\n$indent<ul class=\"menu vertical sublevel-1\" data-toggle>\n";
 }
}
